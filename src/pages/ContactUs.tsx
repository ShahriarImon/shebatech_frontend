...
const ContactUs: FunctionComponent = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${CONFIG.BASE_URL}/send-contact`, {
        method: "POST",
        ...
        <div className={styles.contactInfoCard}>
          ...
          <div className={styles.contactDetails}>
            ...
            <div className={styles.detailItem}>
              ...
              <span>Info@shebatech.com.bd</span>
            </div>
            <div className={styles.detailItem}>
              <svg
                className={styles.icon}
              ...
              <span>
                Khawaja Tower, 95 Bir Uttam AK
                <br />
                Khandakar Rd, Mohakhali C/A, Dhaka 1212
              </span>
            </div>
          </div>
        ...
        <div className={styles.formContainer}>
          <form className={styles.form} onSubmit={(e) => handleSubmit(e)}>
            ...
            {/* <div className={styles.subjectSection}>
              <label className={styles.subjectLabel}>Select Subject?</label>
                ...
                {[1, 2, 3, 4].map((item, index) => (
                  <label key={index} className={styles.radioLabel}>
                    ...
                    <span className={styles.customRadio}>
                      ...
                      {index === 0 && (
                        <svg className={styles.checkIcon} viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className={styles.submitSection}>
              ...
              <div className={styles.planeDecoration}>
                <img
                  src="/letter_send.png"
                  className={styles.letterSendImage}
                  alt=""
                />
                {/* <svg
                  width="283"
                ...
                >
                  <rect
                    ...
                    width="257.297"
                    height="120.005"
                    transform="rotate(-29.7534 0 127.688)"
                    fill="url(#pattern0_15832_592)"
                  />
                  <defs>
                    <pattern
                      id="pattern0_15832_592"
                      patternContentUnits="objectBoundingBox"
                      width="1"
                      height="1"
                    >
                      <use
                        xlink:href="#image0_15832_592"
